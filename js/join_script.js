...
submit.onclick = function(){
    if(validatePhone(phone)){
        if(validateEmail(email)){
            ...
            document.getElementById('h1').innerHTML = 'Thank You! <br><span style="font-size:27px;text-align:center;line-height:35px; matgin-top:10px; display:block;">for expressing your desire to learn</span>';
